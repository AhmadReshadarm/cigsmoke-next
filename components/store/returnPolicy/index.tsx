...
const ReturnPolicyComp = () => {
  return (
    <>
      <Headers>
        Политика возврата товаров в WULUXE (info@wuluxe.ru, 8-800-700-17-41)
      </Headers>
      <Contents>
        WULUXE стремится обеспечить своих клиентов высококачественной продукцией
      ...
      <Contents>
        ...
        >
          <Links title="отправьте письмо по адресу info@wuluxe.ru">
            info@wuluxe.ru
          </Links>
        </Link>{' '}
        или по телефону{' '}
        <Link aria-label="позвонить 89254865444" href="tel:88007001741">
          <Links title="позвонить 8-800-700-17-41">8-800-700-17-41</Links>
        </Link>{' '}
      </Contents>
      ...
      <ListsDots>
        ...
        <li>
          ...
          в течение 14 дней с момента получения товара на складе WULUXE.
        </li>
        <li>
